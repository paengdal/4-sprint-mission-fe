...
import { CommentItemDto } from '@/types/dtos/comment.dto';
...
interface Props {
  ...
  onRegistEdit: (commentId: string, content: string) => void;
}

function CommentItem({ comment, onDelete, onRegistEdit }: Props) {
  const [isEditing, setIsEditing] = useState<boolean>(false);
  const [editedContent, setEditContent] = useState<string>(comment.content);
