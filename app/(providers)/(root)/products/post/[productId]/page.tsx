...
function ProductEditPage() {
  ...
  const [imgUrls, setImgUrls] = useState<string[]>(product.imgUrls);
  ...
  const { mutate: editProduct, isPending } = useMutation({
    mutationFn: (formData: ProductPostDto) =>
      api.editProduct(productId, formData),
    onSuccess: () => {
